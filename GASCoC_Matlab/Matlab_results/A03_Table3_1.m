...
writetable(data, 'C:\Users\akmansoy\HEC PARIS Dropbox\Olivier Akmansoy\cascad Working Files\Certifications\IJF\478\GASCoCAViaR-main\GASCoCAViaR-Linux\GASCC_R\CoVaRCoes\Gaui2sfullCoVaR.csv');
...
writetable(data, '...Your_Path\GASCC_R\CoVaRCoes\POTi2sfullCoVaR.csv');
...
columns = repmat(col,1,31);
data = array2table(GauALall,'VariableNames',colall);
writetable(data, '...Your_Path\GASCC_R\CoVaRCoes\GASCC_R\CoVaRCoes\Gaus2ifullCoVaR.csv');
...
columns = repmat(col,1,31);
data = array2table(POTALall,'VariableNames',colall);
writetable(data, '...Your_Path\GASCC_R\CoVaRCoes\POTs2ifullCoVaR.csv');
