function [paramestall,CoVaRall,CoESall,gammaall,deltaall,Scoreall,p1all,p2all] = GASGARCH1i2sysnew(dataX,dataY,VaRsector,THETA1,THETA2,CoMODEL,p,epsil,miter)
...
parfor i = 1:N
    ...
    while dif>epsil && iter<miter
        ...
        opt3 = @(params)ElcALGAS5new(params,dataY,zt,dataX(:,i),-VaRsector(:,i),es,THETA1,THETA2,p,CoMODEL,gamma0(:,i),delta0(:,i),txlv);
        ...
        [ElAL,~,~,CoVEMnew,CoESEMnew,scoreal,p1,p2] = ElcALGAS5new(paraminit,dataY,zt,dataX(:,i),-VaRsector(:,i),es,THETA1,THETA2,p,CoMODEL,gamma0(:,i),delta0(:,i),txlv);
        CoVEM = -CoVEMnew;
        CoESEM = -CoESEMnew;
        Lcnew = ElAL;
        paraminit = paramest2
