function [paramestall,CoVaRall,CoESall] = constOOS(dataX,dataY,VaRsector,THETA1,THETA2,CoMODEL,epsil,miter)
...
if CoMODEL == 1
    [cobetaSAV,~,CoVaRSAV] = optcavsav27(THETA2,dataX,dataY,VaRsector);
else
    [cobetaAS,~,CoVaRAS] = optcavAS28(THETA2,dataX,dataY,VaRsector);
end
if CoMODEL == 1
    CoVaR = CoVaRSAV;
else
