function [DCCVaR,DCCCoVaR,DCCCoES,parameters] = dccPOTforc(xvec,yvec,xnew,ynew,THETA1,THETA2,stepst)
...
for k =2:(stepst+1)
    ...
    DCCCoVaR0(k) = CoVaRfrocNormalPOT(THETA1,THETA2,Rtnew(1,2,k),diag((Htnew(:,:,k))),ones(stepst+1,1),MUhat,parameters(12),parameters(10),parameters(11));
