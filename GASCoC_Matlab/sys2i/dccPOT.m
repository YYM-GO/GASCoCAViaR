function [parametersall, ll ,Ht, Qt, Rt]=dccPOT(data,dataAsym,m,l,n,p,o,q,gjrType,method,composite,startingVals,options)
...
[H,univariate,parameters,parametersm] = dcc_fit_variance_POT(data2d,p,o,q,gjrType,tarchStartingVals);
stdData = data;
