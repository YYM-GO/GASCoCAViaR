function [paramestall,CoVaRall,CoESall] = consti2sys(dataX,dataY,VaRsector,THETA1,THETA2,CoMODEL,epsil,miter)
...
parfor i = 1:N
    ...
    while dif>epsil && iter<miter
        ...
        opt3 = @(params)ElcALGAS5const(params,dataY,zt,dataX(:,i),-VaRsector(:,i),es,THETA1,THETA2,CoMODEL,gamma0(:,i),txlv);
        ...
        [ElAL,~,~,CoVEMnew,CoESEMnew] = ElcALGAS5const(paraminit,dataY,zt,dataX(:,i),-VaRsector(:,i),es,THETA1,THETA2,CoMODEL,gamma0(:,i),txlv);
        CoVEM = -CoVEMnew;
        CoESEM = -CoESEMnew;
        Lcnew = ElAL;
        paraminit = paramest2;
