...
%         paramGPOT  = fmincon(optPOT ,[cov(xvec)*0.05;0.05;0.9;0.5;0.01],[0,1,1,0,0],1,[],[],-1*ones(5,1),1*ones(5,1),[],options0);
        paramGPOT  = fmincon(optPOT ,[cov(xvec)*0.05;0.05;0.9;0.5;0.01],[0,1,1,0,0],1,[],[],-0.5*ones(5,1),0.999*ones(5,1),[],options0);
    ...
    elseif GMODEL == 3     %CAViaR-SAV
            ...
            VaRin = -VaRin0;
            %         VaRforc0 = RQobjectiveFunction(BetaHat, 2, 1, length(xnew), xnew, THETA1, quantile(xvec,THETA1));
            ...
            VaRin = -VaRin0;
            %         VaRforc0 = RQobjectiveFunction(BetaHat, 2, 2, length(xnew), xnew, THETA1, quantile(xvec,THETA1));
